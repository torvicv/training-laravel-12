            ...
            <div class="relative overflow-hidden bg-white shadow-md sm:rounded-lg dark:bg-gray-800">
                <div class="flex flex-col items-center justify-between space-y-3 p-4 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    >
                        <Link
                            ...
                            class="focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 flex items-center justify-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:ring-4 focus:outline-none"
                        >
                            <svg
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="company in companies" class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium whitespace-nowrap text-gray-900 dark:text-white">{{ company.name }}</th>
                                <td class="px-4 py-3">{{ company.email }}</td>
                                <td class="px-4 py-3">{{ company.address }}</td>
                                <td class="px-4 py-3">{{ company.phone }}</td>
                                <td class="px-4 py-3">{{ company.user.name }}</td>
                                <td class="flex items-center justify-end px-4 py-3">
                                    ...
                                    >
                                        <ul
                                            class="flex items-center justify-end gap-3 py-1 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        >
                                            ...
                                            <li class="py-1">
                                                <Link method="delete" :href="route('companies.destroy', company.id)">
                                                    <svg
